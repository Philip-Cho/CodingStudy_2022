...
따라서, <span style="color: red">**리스트 대신 튜플을 사용**</span>하도록 한다
따라서, <span style="color: red">리스트 대신 튜플을 사용</span>하도록 한다
...
- <span style='background-color: #f5f0ff'>6주차 키패드 누르기</span> 문제의 경우 딕셔너리에 (2,2), (5,5), (8,8), (0,0)와 같은 키값들을 누락시켜서 에러가 발생했다
